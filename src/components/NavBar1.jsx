...
* @see https://v0.dev/t/XrXsp5fNf2t
          ...
          <div className="grid gap-2 py-6">
            ...
            <Collapsible className="grid gap-4">
              <CollapsibleTrigger
                ...
                Products <ChevronRightIcon className="ml-auto h-5 w-5 transition-all" />
              </CollapsibleTrigger>
              <CollapsibleContent>
                <div className="-mx-6 grid gap-6 bg-muted p-6">
                  ...
                  <Link
                    ...
                    className="group grid h-auto w-full justify-start gap-1"
                    prefetch={false}>
                    <div className="text-sm font-medium leading-none group-hover:underline">Product C</div>
                    <div className="line-clamp-2 text-sm leading-snug text-muted-foreground">
